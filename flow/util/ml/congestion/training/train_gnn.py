...
Usage:
  cd flow
  python3 util/ml/congestion/training/train_gnn.py \\
      --data-dir  util/ml/congestion/data \\
      --ckpt-dir  util/ml/congestion/checkpoints \\
      --epochs    100
"""
...
def main():
    ...
    ap.add_argument("--ckpt-dir", default="util/ml/congestion/checkpoints")
